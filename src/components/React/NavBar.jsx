...
const Navbar = () => {
    ...
    return (
        <nav className='flex w-full z-50 justify-center fixed bottom-1.5 left-0 lg:top-0 lg:h-12'>
            <div className='flex flex-col justify-center w-1/2 mb-3 lg:mb-0 lg:w-full lg:flex-row lg:items-center lg:h-12 lg:bg-white dark:lg:bg-[#0623339d] lg:drop-shadow-sm'>
                    ...
                    <li className='flex flex-col gap-3 lg:gap-10 lg:flex-row lg:items-center'>
                        {
                            Links.map((link, index) => (
                                <Link
                                    ...
                                    onClick={closeMenu}
                                    className={`${activeSection == link.section ? 'text-orange-500' : 'text-black dark:text-white'} duration-200 lg:text-sm font-cantora lg:hover:text-orange-500 cursor-pointer`}>{link.name}</Link>
                            ))
                        }
                    </li>
                ...
                <div className='flex items-center justify-around w-full py-1.5 rounded-full bg-[#67676b31] lg:bg-transparent lg:w-auto lg:py-0 dark:lg:bg-transparent gap-2'>
                    ...
                    <a href='../../../public/documents/CV_JESUS_ECHEVERRIA_24.pdf' target='_blank' rel='noopener noreferrer' className='list-none hover:cursor-pointer lg:pb-2'>
